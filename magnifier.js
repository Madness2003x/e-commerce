function magnify(imgID, zoom) {
    ...
    /*remove the magnifier glass when the mouse moves away from the image*/
    ...
    function moveMagnifier(e) {
        ...
        /*set the position of the magnifier glass center at the cursor:*/
        ...
        /* show/hide the magnifier glass based on the hover state of the image */
        if (e.type === "mousemove") {
          glass.style.display = "block";
        } else {
          glass.style.display = "none";
